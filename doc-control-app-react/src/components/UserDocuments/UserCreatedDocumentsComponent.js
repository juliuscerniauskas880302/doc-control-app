...
const UserCreatedDocumentsComponent = (props) => {
    ...
    return (
        <tr>
            ...
            <td>
                <Link style={{ textDecoration: 'none', color: 'black', cursor: 'default' }} to={linkas}> <i className="mygtukas fas fa-info-circle fa-2x"></i> </Link> &nbsp;
                <Link style={{ textDecoration: 'none', color: 'black', cursor: 'default' }} to={`/admin/Documents/${props.id}`}> <i className="mygtukas far fa-edit fa-2x"></i> </Link> &nbsp;
                <i className="mygtukas fas fa-trash fa-2x" onClick={() => { props.handleDelete(props.id) }}></i> &nbsp;
                <i className="mygtukas fas fa-file-signature fa-2x" onClick={() => { props.handleSubmit(props.id) }}></i>
            </td>
        </tr>
